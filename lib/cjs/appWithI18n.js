...
function appWithI18n(AppToTranslate, config) {
  ...
  function AppWithTranslations(props) {
    ...
    return react_1.default.createElement(
      ...
      {
        lang:
          ((_a = props.pageProps) === null || _a === void 0
            ? void 0
            : _a.__lang) ||
          props.__lang ||
          defaultLocale,
        namespaces:
          ((_b = props.pageProps) === null || _b === void 0
            ? void 0
            : _b.__namespaces) || props.__namespaces,
        config: config,
      },
  ...
  AppWithTranslations.getInitialProps = function (appCtx) {
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            return [2, __assign.apply(void 0, _a.concat([_b.sent()]))]
        }
      })
    })
  }

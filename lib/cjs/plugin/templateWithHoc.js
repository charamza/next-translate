...
function templateWithHoc(code, _a) {
  var _b = _a === void 0 ? {} : _a,
    _c = _b.skipInitialProps,
    skipInitialProps = _c === void 0 ? false : _c,
    _d = _b.typescript,
    typescript = _d === void 0 ? false : _d,
    _e = _b.pageName,
    pageName = _e === void 0 ? '__Page_Next_Translate__' : _e,
    _f = _b.hasLoadLocaleFrom,
    hasLoadLocaleFrom = _f === void 0 ? false : _f
  ...
  if (componentName) {
    modifiedCode = modifiedCode.replace(
      new RegExp('\\W'.concat(componentName, '\\.getInitialProps'), 'g'),
      ''.concat(pageName, '.getInitialProps')
    )
  }
  var template =
